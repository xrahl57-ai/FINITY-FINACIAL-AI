  ...
  for (let i = 0; i < modelsToTry.length; i++) {
    ...
    for (let attempt = 1; attempt <= maxAttempts; attempt++) {
      try {
        ...
        const isOverloadedOrRateLimited = errorStr.includes("503") || errorStr.includes("UNAVAILABLE") || errorStr.includes("high demand") || errorStr.includes("429") || errorStr.includes("RESOURCE_EXHAUSTED") || errorStr.includes("overloaded");
...
var DB_PATH = import_path.default.join(DATA_DIR, "finity_db.json");
if (!import_fs.default.existsSync(DATA_DIR)) {
  import_fs.default.mkdirSync(DATA_DIR, { recursive: true });
}
var getSeedState = () => {
  const accounts = [
    { id: "acc-bank", name: "Bank Account (Checking)", type: "ASSET" /* ASSET */, code: "1010", balance: 45e3, description: "Primary operating bank checking account", isSystem: true },
    { id: "acc-cash", name: "Petty Cash", type: "ASSET" /* ASSET */, code: "1020", balance: 2500, description: "Cash on hand for minor daily expenses", isSystem: true },
    { id: "acc-ar", name: "Accounts Receivable", type: "ASSET" /* ASSET */, code: "1100", balance: 8200, description: "Outstanding funds owed by customers", isSystem: true },
    { id: "acc-inventory", name: "Inventory", type: "ASSET" /* ASSET */, code: "1200", balance: 8500, description: "Valuation of stock on hand", isSystem: true },
    { id: "acc-ap", name: "Accounts Payable", type: "LIABILITY" /* LIABILITY */, code: "2010", balance: 3200, description: "Owed money to suppliers and vendors", isSystem: true },
    { id: "acc-tax", name: "Sales Tax Payable", type: "LIABILITY" /* LIABILITY */, code: "2200", balance: 1450, description: "Collected sales tax to be paid to govt", isSystem: false },
    { id: "acc-payroll", name: "Payroll Liabilities", type: "LIABILITY" /* LIABILITY */, code: "2300", balance: 0, description: "Accrued payroll and benefit liabilities", isSystem: false },
    { id: "acc-equity", name: "Owner's Equity (Capital)", type: "EQUITY" /* EQUITY */, code: "3000", balance: 43250, description: "Initial and subsequent capital contributions", isSystem: true },
    { id: "acc-retained", name: "Retained Earnings", type: "EQUITY" /* EQUITY */, code: "3100", balance: 0, description: "Accumulated undistributed net profits", isSystem: true },
    { id: "acc-revenue", name: "Service Revenue", type: "REVENUE" /* REVENUE */, code: "4010", balance: 32e3, description: "Earned income from core services", isSystem: true },
    { id: "acc-sales", name: "Product Sales", type: "REVENUE" /* REVENUE */, code: "4020", balance: 8500, description: "Earned income from inventory sales", isSystem: false },
    { id: "acc-rent", name: "Rent Expense", type: "EXPENSE" /* EXPENSE */, code: "5010", balance: 6e3, description: "Office lease payments", isSystem: true },
    { id: "acc-salaries", name: "Salaries & Wages Expense", type: "EXPENSE" /* EXPENSE */, code: "5020", balance: 12e3, description: "Employee compensation", isSystem: true },
    { id: "acc-utilities", name: "Utilities Expense", type: "EXPENSE" /* EXPENSE */, code: "5030", balance: 1200, description: "Electricity, internet, and phone bills", isSystem: false },
    { id: "acc-marketing", name: "Advertising & Marketing", type: "EXPENSE" /* EXPENSE */, code: "5040", balance: 3500, description: "Promotions, ads, and sponsorships", isSystem: false },
    { id: "acc-software", name: "Software & SaaS Subscriptions", type: "EXPENSE" /* EXPENSE */, code: "5050", balance: 1500, description: "Cloud software, CRM, and analytics tools", isSystem: false }
  ];
  const partners = [
    ...
    { id: "part-wework", name: "WeWork Renting LLC", type: "supplier", email: "spaces@wework.com", phone: "(555) 888-0099", address: "85 Broad St, New York, NY", balance: 2e3 },
  ...
  const transactions = [
    { id: "tx-1", date: "2026-06-01", description: "Opening capital contribution", accountId: "acc-bank", offsetAccountId: "acc-equity", amount: 5e4, category: "Equity", type: "income", status: "posted" },
    { id: "tx-2", date: "2026-06-02", description: "Office rent payment (June)", accountId: "acc-bank", offsetAccountId: "acc-rent", amount: -2e3, category: "Rent", type: "expense", status: "posted" },
    { id: "tx-3", date: "2026-06-15", description: "Consulting project milestone - Wayne Corp", accountId: "acc-bank", offsetAccountId: "acc-revenue", amount: 15e3, category: "Revenue", type: "income", status: "posted" },
    { id: "tx-4", date: "2026-06-25", description: "Software subscription revenue - Acme Corp", accountId: "acc-bank", offsetAccountId: "acc-revenue", amount: 1e4, category: "Revenue", type: "income", status: "posted" },
    { id: "tx-5", date: "2026-06-28", description: "Monthly salaries payment", accountId: "acc-bank", offsetAccountId: "acc-salaries", amount: -6e3, category: "Salaries", type: "expense", status: "posted" },
    ...
    { id: "tx-7", date: "2026-07-01", description: "Office rent payment (July)", accountId: "acc-bank", offsetAccountId: "acc-rent", amount: -2e3, category: "Rent", type: "expense", status: "posted" },
  ...
  const journalEntries = [
    {
      ...
      status: "posted",
      lines: [
        { accountId: "acc-bank", debit: 45e3, credit: 0 },
        { accountId: "acc-cash", debit: 2500, credit: 0 },
        { accountId: "acc-ar", debit: 8200, credit: 0 },
        { accountId: "acc-inventory", debit: 8500, credit: 0 },
        { accountId: "acc-rent", debit: 6e3, credit: 0 },
        { accountId: "acc-salaries", debit: 12e3, credit: 0 },
        ...
        { accountId: "acc-revenue", debit: 0, credit: 32e3 },
  ...
  const invoices = [
    ...
    },
    {
      ...
      status: "sent",
      items: [
        { description: "FinTech Strategic Consulting - Milestone 1", quantity: 20, unitPrice: 200, amount: 4e3 },
  ...
  const bills = [
    ...
    },
    {
      ...
      dueDate: "2026-07-15",
      status: "received",
      items: [{ description: "Co-working space dedicated desks - July", quantity: 4, unitPrice: 500, amount: 2e3 }],
      total: 2e3,
      balanceDue: 2e3
    }
  ];
  const projects = [
    { id: "proj-1", name: "Global ERP Upgrade", description: "Strategic corporate ledger transition project", budget: 25e3, cost: 4500, status: "active" },
    { id: "proj-2", name: "Tokenized Payment Gateway", description: "Prototype secure wallet terminal deployment", budget: 15e3, cost: 1200, status: "active" }
  ];
  const budgets = [
    { id: "bud-1", category: "Rent", amount: 2500, spent: 2e3, period: "2026-07" },
    { id: "bud-2", category: "Software", amount: 2e3, spent: 1200, period: "2026-07" },
    { id: "bud-3", category: "Salaries", amount: 8e3, spent: 6e3, period: "2026-07" }
  ];
  const receipts = [
  ...
  const bankConnections = [
    {
      ...
      transactions: [
        { id: "btx-1", date: "2026-07-01", description: "TRANSFER rent space", amount: -2e3, reconciled: true },
    ...
    },
    {
      ...
      lastSynced: "2026-07-08T06:00:00-07:00",
      transactions: [
        { id: "btx-svb-1", date: "2026-07-02", description: "Venture Debt Payment", amount: -5e3, reconciled: true },
        { id: "btx-svb-2", date: "2026-07-05", description: "Stark Industries Wire", amount: 15e3, reconciled: false }
      ]
    }
  ];
  const wallets = [
    ...
    { id: "wal-2", name: "European Treasury EUR Wallet", currency: "EUR", balance: 5e3, provider: "Finity Core", lastUpdated: "2026-07-08T22:00:00-07:00" },
  ...
  const activePayments = [
    ...
    { id: "pay-2", date: "2026-07-06", type: "payroll", amount: 3e3, currency: "USD", recipientName: "John Doe", status: "completed", routingPath: "Direct Deposit Via Stripe Treasury", settlementTime: "Instant", sourceType: "wallet", sourceId: "wal-1" },
...
var getEmptyState = (keepProfile = true, currentProfile) => {
  const accounts = [
    { id: "acc-bank", name: "Bank Account (Checking)", type: "ASSET" /* ASSET */, code: "1010", balance: 0, description: "Primary operating bank checking account", isSystem: true },
    { id: "acc-cash", name: "Petty Cash", type: "ASSET" /* ASSET */, code: "1020", balance: 0, description: "Cash on hand for minor daily expenses", isSystem: true },
    { id: "acc-ar", name: "Accounts Receivable", type: "ASSET" /* ASSET */, code: "1100", balance: 0, description: "Outstanding funds owed by customers", isSystem: true },
    { id: "acc-inventory", name: "Inventory", type: "ASSET" /* ASSET */, code: "1200", balance: 0, description: "Valuation of stock on hand", isSystem: true },
    { id: "acc-ap", name: "Accounts Payable", type: "LIABILITY" /* LIABILITY */, code: "2010", balance: 0, description: "Owed money to suppliers and vendors", isSystem: true },
    { id: "acc-tax", name: "Sales Tax Payable", type: "LIABILITY" /* LIABILITY */, code: "2200", balance: 0, description: "Collected sales tax to be paid to govt", isSystem: false },
    { id: "acc-payroll", name: "Payroll Liabilities", type: "LIABILITY" /* LIABILITY */, code: "2300", balance: 0, description: "Accrued payroll and benefit liabilities", isSystem: false },
    { id: "acc-equity", name: "Owner's Equity (Capital)", type: "EQUITY" /* EQUITY */, code: "3000", balance: 0, description: "Initial and subsequent capital contributions", isSystem: true },
    { id: "acc-retained", name: "Retained Earnings", type: "EQUITY" /* EQUITY */, code: "3100", balance: 0, description: "Accumulated undistributed net profits", isSystem: true },
    { id: "acc-revenue", name: "Service Revenue", type: "REVENUE" /* REVENUE */, code: "4010", balance: 0, description: "Earned income from core services", isSystem: true },
    { id: "acc-sales", name: "Product Sales", type: "REVENUE" /* REVENUE */, code: "4020", balance: 0, description: "Earned income from inventory sales", isSystem: false },
    { id: "acc-rent", name: "Rent Expense", type: "EXPENSE" /* EXPENSE */, code: "5010", balance: 0, description: "Office lease payments", isSystem: true },
    { id: "acc-salaries", name: "Salaries & Wages Expense", type: "EXPENSE" /* EXPENSE */, code: "5020", balance: 0, description: "Employee compensation", isSystem: true },
    { id: "acc-utilities", name: "Utilities Expense", type: "EXPENSE" /* EXPENSE */, code: "5030", balance: 0, description: "Electricity, internet, and phone bills", isSystem: false },
    { id: "acc-marketing", name: "Advertising & Marketing", type: "EXPENSE" /* EXPENSE */, code: "5040", balance: 0, description: "Promotions, ads, and sponsorships", isSystem: false },
    { id: "acc-software", name: "Software & SaaS Subscriptions", type: "EXPENSE" /* EXPENSE */, code: "5050", balance: 0, description: "Cloud software, CRM, and analytics tools", isSystem: false }
  ];
  const emptyState = {
    accounts,
    transactions: [],
    ...
    activePayments: [],
    auditLogs: [
      { id: "log-clear-" + Date.now(), timestamp: (/* @__PURE__ */ new Date()).toISOString(), action: "Database Clear", entityType: "Database", entityId: "all", details: "Database cleared successfully. Starting with an empty slate.", user: "System OS" }
    ],
    accountingPeriod: "active",
    fiscalYearClosed: false,
    exchangeRates: {
...
function calculateAgentVitals(state) {
  const getBalanceSum = (types) => {
    return state.accounts.filter((acc) => types.includes(acc.type)).reduce((sum, acc) => sum + acc.balance, 0);
  };
  ...
  const totalRevenue = getBalanceSum(["REVENUE" /* REVENUE */]);
  const totalExpenses = getBalanceSum(["EXPENSE" /* EXPENSE */]);
  ...
  const equityBalance = getBalanceSum(["EQUITY" /* EQUITY */]);
  ...
  const vitalsInsight = healthScore > 85 ? `Optimal vitals at ${healthScore}%. Your cash position is strong, and overdue receivables are fully minimized.` : `Vitals score is ${healthScore}%. Focus on collections of the ${overdueInvoices.length} overdue invoice(s) to optimize operational safety.`;
  const profitsInsight = netProfit >= 0 ? `Healthy operational net profitability of $${netProfit.toLocaleString()}. Profit margin is currently at ${netProfitMargin.toFixed(1)}%.` : `Net loss is currently $${Math.abs(netProfit).toLocaleString()}. Consider reviewing office overhead or pausing unneeded SaaS.`;
  ...
  const treasuryInsight = cashPosition >= 5e4 ? `Liquid cash is high at $${cashPosition.toLocaleString()}, which exceeds your benchmark $50,000 safety zone.` : `Runway warning: Liquid reserves ($${cashPosition.toLocaleString()}) are below the target $50,000. Accelerate customer payment cycles.`;
  const auditInsight = ledgerBalanced ? "Double-entry integrity check passed (Assets = Liabilities + Equity). No transaction discrepancies found." : `Discrepancy found: Ledger is out of alignment by $${ledgerDiscrepancy.toFixed(2)}. Suggesting balance re-alignment entries.`;
  return {
    healthScore,
    netProfit,
    totalExpenses,
...
function writeDbState(state) {
  try {
    import_fs.default.writeFileSync(DB_PATH, JSON.stringify(state, null, 2), "utf-8");
  } catch (error) {
    console.error("Failed to write database state.", error);
  }
}
function addAuditLog(state, action, type, id, details) {
  const newLog = {
    id: "log-" + Date.now(),
...
function recalculateBalances(state) {
  ...
  state.journalEntries.forEach((je) => {
    ...
    je.lines.forEach((line) => {
      ...
      if (acc) {
        if (acc.type === "ASSET" /* ASSET */ || acc.type === "EXPENSE" /* EXPENSE */) {
...
app.post("/api/onboarding/send-verification", async (req, res) => {
  try {
    ...
    if (!testSmtpAccount) {
      testSmtpAccount = await import_nodemailer.default.createTestAccount();
    }
...
This code is valid for 10 minutes. If you did not request this, please ignore this email.`,
    ...
    const viewUrl = import_nodemailer.default.getTestMessageUrl(info);
...
app.post("/api/state/onboard", (req, res) => {
  try {
    ...
    const currencySymbol = financial?.currency === "EUR" ? "\u20AC" : financial?.currency === "GBP" ? "\xA3" : financial?.currency === "CAD" ? "C$" : financial?.currency === "AUD" ? "A$" : "$";
    ...
    if (onboardingType === "business") {
      ...
      const standardAccounts = [
        { id: "acc-bank", name: `Bank Account (${connected?.bankName || "Checking"})`, type: "ASSET" /* ASSET */, code: "1010", balance: Number(connected?.bankBalance) || 45e3, description: "Primary operating bank checking account", isSystem: true },
        { id: "acc-cash", name: "Petty Cash Wallet", type: "ASSET" /* ASSET */, code: "1020", balance: 2500, description: "Cash on hand for minor daily expenses", isSystem: true },
        { id: "acc-ar", name: "Accounts Receivable (A/R)", type: "ASSET" /* ASSET */, code: "1100", balance: 12500, description: "Outstanding client invoicing", isSystem: true },
        { id: "acc-inventory", name: "Product Inventory Asset", type: "ASSET" /* ASSET */, code: "1200", balance: 18e3, description: "Valuation of commercial inventory", isSystem: true },
        { id: "acc-ap", name: "Accounts Payable (A/P)", type: "LIABILITY" /* LIABILITY */, code: "2010", balance: 6400, description: "Owed funds to supplier partners", isSystem: true },
        { id: "acc-tax", name: "Sales Tax Liability", type: "LIABILITY" /* LIABILITY */, code: "2200", balance: 1200, description: "Collected sales tax payable to authority", isSystem: true },
        { id: "acc-equity", name: "Retained Earnings", type: "EQUITY" /* EQUITY */, code: "3000", balance: 61400, description: "Accumulated operational reserves", isSystem: true },
        { id: "acc-revenue", name: "Core Product Sales", type: "REVENUE" /* REVENUE */, code: "4000", balance: 28500, description: "Main stream revenue from commercial channels", isSystem: true },
        { id: "acc-rent", name: "Office Leasing Expense", type: "EXPENSE" /* EXPENSE */, code: "5010", balance: 4500, description: "Office rental and workspace subscription expenses", isSystem: true },
        { id: "acc-payroll", name: "Salaries & Payroll", type: "EXPENSE" /* EXPENSE */, code: "5020", balance: 12e3, description: "Salaries paid to company team members", isSystem: true },
        { id: "acc-marketing", name: "Marketing & Growth", type: "EXPENSE" /* EXPENSE */, code: "5030", balance: 3500, description: "Acquisition and search engine marketing costs", isSystem: true },
        { id: "acc-hosting", name: "AWS Cloud Infrastructure", type: "EXPENSE" /* EXPENSE */, code: "5040", balance: 1200, description: "Cloud computing and network storage overheads", isSystem: true }
      ];
      state.accounts = standardAccounts;
      state.transactions = [
        { id: "tx-ob-1", date: "2026-07-01", description: "Initial Equity Contribution", accountId: "acc-bank", offsetAccountId: "acc-equity", amount: Number(connected?.bankBalance) || 45e3, category: "Equity", type: "income", status: "posted" },
        ...
        { id: "tx-ob-4", date: "2026-07-04", description: "Employee Payroll Allocation", accountId: "acc-bank", offsetAccountId: "acc-payroll", amount: -6e3, category: "Payroll", type: "expense", status: "posted" }
      ];
        ...
        state.bankConnections = [
          {
            ...
            balance: Number(connected.bankBalance) || 45e3,
      ...
      state.wallets = [
        { id: "wal-ob-usd", name: "Operating USD Wallet", currency: currencyCode, balance: 1e4, provider: "Finity Core", lastUpdated: (/* @__PURE__ */ new Date()).toISOString() }
      ];
      state.paymentGateways = [
        { id: "pg-ob-stripe", name: connected?.gatewayConnected ? `${connected.gatewayConnected} API Gateway` : "Stripe Connect Portal", status: connected?.gatewayConnected ? "connected" : "disconnected", environment: "sandbox", credentialsType: "API Key", lastPing: (/* @__PURE__ */ new Date()).toISOString() }
      ];
      state.partners = [
      ...
      state.auditLogs = [
        { id: `audit-${Date.now()}-1`, timestamp: (/* @__PURE__ */ new Date()).toISOString(), action: "Workspace Onboarding", entityType: "Company", entityId: "finity-workspace", details: `Company workspace '${companyInfo?.companyName}' registered under Base Currency '${currencyCode}' and industry '${companyInfo?.industry || "Tech"}'.`, user: account?.fullName || "System OS" },
        { id: `audit-${Date.now()}-2`, timestamp: (/* @__PURE__ */ new Date()).toISOString(), action: "Policy Configuration", entityType: "Security", entityId: "mfa", details: `Multi-factor authentication (MFA) status updated: ${account?.mfaEnabled ? "ENABLED" : "DISABLED"}.`, user: "System OS" }
      ];
    } else {
      ...
      const personalAccounts = [
        { id: "acc-bank", name: "Personal Checking Account", type: "ASSET" /* ASSET */, code: "1010", balance: 8500, description: "Day-to-day transaction account", isSystem: true },
        { id: "acc-savings", name: "High-Yield Savings", type: "ASSET" /* ASSET */, code: "1020", balance: 25e3, description: "Emergency fund & personal investments", isSystem: true },
        { id: "acc-card", name: "Finity Metal Credit Card", type: "LIABILITY" /* LIABILITY */, code: "2010", balance: 1420, description: "Personal credit card balance", isSystem: true },
        { id: "acc-equity", name: "Net Worth Reserve", type: "EQUITY" /* EQUITY */, code: "3000", balance: 32080, description: "Personal net worth baseline", isSystem: true },
        { id: "acc-revenue", name: "Primary Salary Revenue", type: "REVENUE" /* REVENUE */, code: "4000", balance: 6500, description: "Monthly paycheck and primary earnings", isSystem: true },
        { id: "acc-sidehustle", name: "Side Hustle Consulting", type: "REVENUE" /* REVENUE */, code: "4100", balance: 1200, description: "Alternative secondary gig earnings", isSystem: true },
        { id: "acc-rent", name: "Monthly Rent / Mortgage", type: "EXPENSE" /* EXPENSE */, code: "5010", balance: 1800, description: "Residential monthly housing costs", isSystem: true },
        { id: "acc-groceries", name: "Groceries & Supermarket", type: "EXPENSE" /* EXPENSE */, code: "5020", balance: 450, description: "Weekly food and essential supplies", isSystem: true },
        { id: "acc-dining", name: "Dining & Coffee Shops", type: "EXPENSE" /* EXPENSE */, code: "5030", balance: 250, description: "Social dining out, cafes, and leisure food", isSystem: true },
        { id: "acc-travel", name: "Transport & Rideshare", type: "EXPENSE" /* EXPENSE */, code: "5040", balance: 180, description: "Gasoline, public transit, and Uber rides", isSystem: true }
      ];
      ...
      state.wallets = [
        { id: "wal-ob-personal", name: "Personal Digital USD Wallet", currency: currencyCode, balance: 2500, provider: "Finity Pay", lastUpdated: (/* @__PURE__ */ new Date()).toISOString() }
      ];
      state.paymentGateways = [];
      state.partners = [];
      state.auditLogs = [
        { id: `audit-${Date.now()}-1`, timestamp: (/* @__PURE__ */ new Date()).toISOString(), action: "Personal Onboarding", entityType: "User", entityId: "personal-workspace", details: `Personal financial workspace registered under Base Currency '${currencyCode}' for user '${personal?.name}'.`, user: personal?.name || "System OS" }
      ];
    }
    writeDbState(state);
...
app.post("/api/state/reset-onboard", (req, res) => {
  ...
  state.companyProfile = void 0;
  state.personalProfile = void 0;
  state.userCredentials = void 0;
  writeDbState(state);
  res.json({ status: "success", state });
});
...
app.post("/api/state/close-year", (req, res) => {
  ...
  const revenueSum = state.accounts.filter((a) => a.type === "REVENUE" /* REVENUE */).reduce((sum, a) => sum + a.balance, 0);
  const expenseSum = state.accounts.filter((a) => a.type === "EXPENSE" /* EXPENSE */).reduce((sum, a) => sum + a.balance, 0);
  ...
  state.accounts.filter((a) => a.type === "REVENUE" /* REVENUE */).forEach((acc) => {
    if (acc.balance !== 0) {
      closingJe.lines.push({ accountId: acc.id, debit: acc.balance, credit: 0 });
    }
  });
  state.accounts.filter((a) => a.type === "EXPENSE" /* EXPENSE */).forEach((acc) => {
    if (acc.balance !== 0) {
...
app.post("/api/payments/send", (req, res) => {
  ...
  let usdValue = payAmt;
  const rates = state.exchangeRates || { "USD": 1, "EUR": 1.08, "GBP": 1.28 };
  const rate = rates[currency] || 1;
  usdValue = payAmt * rate;
  if (sourceType === "bank") {
    ...
    wallet.lastUpdated = (/* @__PURE__ */ new Date()).toISOString();
  } else {
...
app.post("/api/payments/convert", (req, res) => {
  ...
  const rates = state.exchangeRates || { "USD": 1, "EUR": 1.08, "GBP": 1.28 };
  const fromRate = rates[fromWallet.currency] || 1;
  const toRate = rates[toWallet.currency] || 1;
  const usdValue = convAmt * fromRate;
  const toAmount = usdValue / toRate;
  fromWallet.balance -= convAmt;
  toWallet.balance += toAmount;
  fromWallet.lastUpdated = (/* @__PURE__ */ new Date()).toISOString();
  toWallet.lastUpdated = (/* @__PURE__ */ new Date()).toISOString();
...
app.post("/api/payments/connect-bank", (req, res) => {
  ...
  const newConn = {
    ...
    balance: Number(balance) || 1e4,
    lastSynced: (/* @__PURE__ */ new Date()).toISOString(),
    transactions: [
      { id: "btx-link-" + Date.now(), date: (/* @__PURE__ */ new Date()).toISOString().split("T")[0], description: "Plaid link validation deposit", amount: 1.5, reconciled: false }
    ]
  };
...
app.post("/api/payments/connect-financial-accounts", (req, res) => {
  ...
  if (type === "bank") {
    ...
    const addedAccounts = [];
    selectedSubAccounts.forEach((subAcc, idx) => {
      ...
      const newConn = {
        ...
        lastSynced: (/* @__PURE__ */ new Date()).toISOString(),
        transactions: [
          { id: `btx-init-${Date.now()}-${idx}`, date: (/* @__PURE__ */ new Date()).toISOString().split("T")[0], description: "Plaid connection verification", amount: 1.5, reconciled: false },
          { id: `btx-base-1-${Date.now()}-${idx}`, date: new Date(Date.now() - 2 * 24 * 60 * 60 * 1e3).toISOString().split("T")[0], description: "Corporate SaaS subscription sync", amount: -45.99, reconciled: false },
          { id: `btx-base-2-${Date.now()}-${idx}`, date: new Date(Date.now() - 1 * 24 * 60 * 60 * 1e3).toISOString().split("T")[0], description: "Acme Client Invoice deposit", amount: 1250, reconciled: false }
        ]
      };
      state.bankConnections.push(newConn);
...
app.post("/api/payments/sync-financial-account", (req, res) => {
  ...
  if (type === "gateway") {
    ...
    gateway.lastPing = (/* @__PURE__ */ new Date()).toISOString();
...
app.post("/api/invoices", (req, res) => {
  ...
  const newInvoice = {
    id: "inv-" + Date.now(),
    invoiceNumber: "INV-" + (/* @__PURE__ */ new Date()).getFullYear() + "-" + (state.invoices.length + 1).toString().padStart(3, "0"),
    customerId,
    customerName: customer.name,
    date: (/* @__PURE__ */ new Date()).toISOString().split("T")[0],
    dueDate: dueDate || new Date(Date.now() + 30 * 24 * 60 * 60 * 1e3).toISOString().split("T")[0],
    status: "sent",
    items: invoiceItems,
    subtotal,
    taxRate: taxRateNum,
    ...
    const response = await generateContentWithFallback(ai, {
      ...
      contents: [
        {
          inlineData: {
            mimeType: "image/png",
            // support standard image/png or image/jpeg
            data: base64Data
          }
        },
        prompt
      ...
      config: {
        ...
        responseSchema: {
          ...
          properties: {
            merchant: { type: import_genai.Type.STRING, description: "Name of the merchant/vendor" },
            date: { type: import_genai.Type.STRING, description: "Transaction date in YYYY-MM-DD" },
            amount: { type: import_genai.Type.NUMBER, description: "Total receipt amount" },
            taxAmount: { type: import_genai.Type.NUMBER, description: "Sales tax amount" },
            category: { type: import_genai.Type.STRING, description: "Categorized expense label" },
            confidenceScore: { type: import_genai.Type.NUMBER, description: "Extraction confidence from 0 to 1" }
          },
...
function extractResponseFromPartialJson(partialJson) {
...
- Fiscal Year Closed: ${state.fiscalYearClosed}`;
    const profileContext = state.companyProfile ? `[BUSINESS / COMPANY PROFILE]
...
- Base Currency: ${state.personalProfile.currency}` : "[PROFILE] No onboarding profile found.";
    const systemInstruction = `
      ...
      - UK (United Kingdom): VAT. Standard Rate: 20%, Reduced Rate: 5%, Zero Rate: 0%. Threshold: \xA390,000 taxable turnover. Regional Notes: Compulsory registration above threshold. 5% reduced rate applies to energy, home conversions.
      ...
      - JP (Japan): Consumption Tax. Standard Rate: 10%, Reduced Rate: 8%, Zero Rate: 0%. Threshold: \xA510,000,000 taxable sales. Regional Notes: Reduced rate of 8% is applied strictly to food/beverages and newspapers.
      ...
      - CN (China): VAT. Standard Rate: 13%, Reduced Rate: 9%, Zero Rate: 0%. Threshold: \xA5100,000 monthly sales (small taxpayers). Regional Notes: Standard manufacturing is 13%; services standard is 6%; transport/construction is 9%.
    ...
    for (let i = 0; i < modelsToTry.length; i++) {
      ...
      for (let attempt = 1; attempt <= maxAttempts; attempt++) {
        try {
          ...
          const currentStream = await ai.models.generateContentStream({
            ...
            config: {
              ...
              responseSchema: {
                type: import_genai.Type.OBJECT,
                properties: {
                  response: { type: import_genai.Type.STRING, description: "Conversational answer or explanation in Markdown format" },
                  action: {
                    type: import_genai.Type.OBJECT,
                    properties: {
                      type: { type: import_genai.Type.STRING, description: "Type of financial action to run" },
                      payload: { type: import_genai.Type.OBJECT, description: "Key value parameters for the action" }
                    },
                    required: ["type"]
                  }
                },
          ...
          lastError = error;
          const errorStr = String(error.message || error);
          const isOverloaded = errorStr.includes("503") || errorStr.includes("UNAVAILABLE") || errorStr.includes("high demand") || errorStr.includes("429") || errorStr.includes("RESOURCE_EXHAUSTED") || errorStr.includes("overloaded");
          if (isOverloaded) {
...
`);
    ...
    if (parsedResult.action && parsedResult.action.type) {
      ...
      if (type === "RECORD_TRANSACTION" && payload) {
        ...
        const budgetPeriod = period || (/* @__PURE__ */ new Date()).toISOString().slice(0, 7);
        ...
        let expenseAccount = "acc-software";
        if (billItems.some((bi) => bi.description.toLowerCase().includes("rent") || bi.description.toLowerCase().includes("space"))) {
          expenseAccount = "acc-rent";
        } else if (billItems.some((bi) => bi.description.toLowerCase().includes("electric") || bi.description.toLowerCase().includes("utilities") || bi.description.toLowerCase().includes("water"))) {
          expenseAccount = "acc-utilities";
        } else if (billItems.some((bi) => bi.description.toLowerCase().includes("salary") || bi.description.toLowerCase().includes("wage") || bi.description.toLowerCase().includes("payroll"))) {
        ...
        if (connectionType === "bank") {
          ...
          const subBal = Number(balance) || 12e3;
          const newConn = {
            id: `bc-nlu-${Date.now()}`,
            ...
            lastSynced: (/* @__PURE__ */ new Date()).toISOString(),
            transactions: [
              { id: `btx-init-${Date.now()}`, date: (/* @__PURE__ */ new Date()).toISOString().split("T")[0], description: "Authorized via Finity Agent NLU", amount: 1.5, reconciled: false }
            ]
          };
          state.bankConnections.push(newConn);
          state.transactions.unshift({
